...
export const BrainIcon = ({ className = "" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C7.58 2 4 5.58 4 10v2.5c0 3.59 2.91 6.5 6.5 6.5H13v-1.5h-2.5c-2.76 0-5-2.24-5-5V10c0-3.31 2.69-6 6-6s6 2.69 6 6v2.5c0 2.76-2.24 5-5 5H12v1.5h.5c3.59 0 6.5-2.91 6.5-6.5V10c0-4.42-3.58-8-8-8z" />
    </svg>
);
...
export const SpeakerIcon = ({ className, isSpeaking }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        {isSpeaking ? (
